...
{
   public class StatisticsBySubjectsViewModel : ViewModelBase
    {
        #region Propierties
        ...
        public StatisticsBySubjectsViewModel()
        {
        ...
        public void GetStudentExamsBySubjectAndExam()
        {
            ...
            if (CurrentSubjectNameEVM != null)
            {
                ...
                if (CurrentExamNameEVM != null)
                {
                    ...
                    {
                        ErrorsSVM = "No hay estudiante seleccionado del examen";
                    }
        ...
        public RouteCommand LoadDataByNameCommand { get; set; }
        public RouteCommand GetSubjectByStudentsEVCommand { get; set; }
        public RouteCommand GetStudentExamsBySubjectCommand { get; set; }
