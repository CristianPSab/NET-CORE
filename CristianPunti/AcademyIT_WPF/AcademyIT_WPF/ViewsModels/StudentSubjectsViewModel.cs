...
namespace Academy.App.WPF.ViewsModels
{
    public class StudentSubjectsViewModel : ViewModelBase
    {
        ...
        private void FindStudent()
        {
            ...
            //ValidationResult<string> vrStudent;

            //if (!(vrStudent = StudentSubject.ValidateName(CurrentStudentSubject.StudentId, CurrentStudentSubject.SubjectId, CurrentStudentSubject.Id)).IsSuccess)
            //{
            //    MessageBox.Show(vrStudent.AllErrors);
            //}
